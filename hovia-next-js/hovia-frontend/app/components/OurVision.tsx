...
import { Box, SimpleGrid, Icon, Text, Stack, Flex, useBreakpointValue, Container } from '@chakra-ui/react';
  ...
  return (
    <Container maxW={"8xl"} p={5}>
        ...
        <Feature
          title={'OUR VISION'}
          text={
            `To be the preferred educational consultants, academically empowering professionals
        ...
        <Feature
          title={'OUR MISSION'}
          text={
            `In our Training and Consulting Services we continuously strive to apply best practices in the
        ...
        <Feature
          title={'OUR VALUES'}
          text={
          `Transparency, Social Responsibility, Accountability, Teamwork, Integrity, and Relevance.`}
        />
         <Feature
          title={'OUR SLOGAN'}
          text={
